...
async function main() {
  ...
  const accounts = [
    ...
    { name: "Salud/Farmacia", type: AccountType.expense },
    { name: "Belleza/Cuidado Personal", type: AccountType.expense },
    { name: "Tecnología/Hardware", type: AccountType.expense },
    { name: "Compras Generales", type: AccountType.expense },
